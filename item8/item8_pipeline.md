...
- [`dim_produto_pipeline.csv`](dim_produto_pipeline.csv) — 118.333 produtos (sem as colunas de link de imagem/produto, removidas para respeitar o limite de upload do GitHub — mesma solução aplicada no Item 9)
