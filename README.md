...
| "Quero conseguir usar isso no dia a dia sem depender de um analista" | [Item 9](item9_data_app.md) | Data App em Streamlit para exploração self-service dos dados, publicado no Streamlit Community Cloud |
...
├── item9_data_app.md          → documentação do Item 9 (fica na raiz, junto com o app, por exigência do Streamlit Cloud)
├── data_app_funcionando.png   → print do Data App em funcionamento
